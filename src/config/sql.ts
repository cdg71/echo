...
export const getSurveyTestDatasetStatement = async () => {
  ...
  return `
    ...
    VALUES (
        'test',
        'FPT ❤️ IA',
        '### L''Intelligence Artificielle au service des territoires\n![FPT ❤️ IA](/static/images/artificial_intelligence.svg)\nEn pleine transformation numérique, **l''IA est un sujet d''actualité brûlant** qui suscite de nombreuses interrogations.\n\n**Est-ce un atout ou au contraire une menace ?**', 
